...
| [`agentic-coding.md`](./agentic-coding.md) | 범용 AI 에이전트 행동 규칙 — 기본 원칙, Git 워크플로우, 코드 품질, 자율성 범위, 커뮤니케이션 등       |
| [`AI_RULES.md`](./AI_RULES.md)             | 프로젝트 전용 AI 에이전트 지침 — DEVLOG/TODO 관리, Git 반영 절차 (범용 규칙은 agentic-coding.md 참조) |
